...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/minidrone/repos/optiTrackDrone/mav-ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/minidrone/repos/optiTrackDrone/mav-ws/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/minidrone/repos/optiTrackDrone/mav-ws/install)
...
if(NOT "/home/minidrone/repos/optiTrackDrone/mav-ws/src/mavros/libmavconn/include;/usr/include;/home/minidrone/repos/optiTrackDrone/mav-ws/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/minidrone/repos/optiTrackDrone/mav-ws/src/mavros/libmavconn/include;/usr/include;/home/minidrone/repos/optiTrackDrone/mav-ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/minidrone/repos/optiTrackDrone/mav-ws/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/minidrone/repos/optiTrackDrone/mav-ws/devel/.private/libmavconn/lib;/home/minidrone/repos/optiTrackDrone/mav-ws/devel/lib;/opt/ros/melodic/lib)
